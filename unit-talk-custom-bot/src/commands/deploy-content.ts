...
async function deploySingleSection(interaction: ChatInputCommandInteraction, section: string, targetChannel: TextChannel | null) {
...
function createCapperGuideEmbed(guild: any) {
  const embed = new EmbedBuilder()
    ...
    .setDescription(
      ...
      `**📱 To follow a capper:**\n` +
      `• Subscribe to their threads to get instant alerts\n` +
