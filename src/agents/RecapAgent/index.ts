...
export class RecapAgent extends BaseAgent {
  ...
  /**
   * Persisted recap run history.  Used by Temporal workflows and
   * micro-recap cooldown logic to guarantee idempotency across restarts.
   */
  ...
  protected async process(): Promise<void> {
    ...
    try {
      ...
      this.logger.error(
        'RecapAgent micro-recap processing failed:',
