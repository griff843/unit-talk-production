-- =============================================================================
-- PHASE 1: SAAS FOUNDATION - DIRECT SQL EXECUTION
...
CREATE TABLE IF NOT EXISTS unified_picks (
  ...
  -- Relationships (foreign keys added later)
...
-- Step 4.5: Add foreign key constraints after tables are created
-- =============================================================================

-- Add foreign keys to unified_picks
ALTER TABLE unified_picks
  ADD CONSTRAINT fk_unified_picks_user_id
  FOREIGN KEY (user_id) REFERENCES users(id) ON DELETE CASCADE;

-- Add foreign keys to raw_props and games if they exist
DO $$
BEGIN
  -- Check if raw_props table exists and add foreign key
  ...
  -- Check if games table exists and add foreign key
...
-- Add foreign keys to parlay_tickets
