 ...
 *
 * Provides dry-run sprint planning from governed inputs.
 * Does NOT mutate source code. Planning only.
 *
 * Usage:
 *   npx tsx src/cli.ts plan --sprint SPRINT-044R --type runtime --summary "description"
 *   npx tsx src/cli.ts validate
 *   npx tsx src/cli.ts plan --sprint SPRINT-044R --type runtime --summary "description" --json
 */
...
${c.bold}Philosophy:${c.reset}
  This tool is dry-run only. It loads governance artifacts, resolves
  requirements, evaluates drift risk, and produces a plan. It does NOT
  modify source code or execute verification commands.
`);
}
