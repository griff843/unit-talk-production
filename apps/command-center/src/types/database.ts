 ...
 *
 * SPRINT-DATABASE-TYPE-CENTRALIZATION-003:
 * Canonical Row types are exported from @unit-talk/shared-types.
 * This file is the complete Supabase schema and should eventually be
 * migrated to packages/shared-types/src/supabase.ts as the single source.
 *
 * For now, apps should import canonical Row types from @unit-talk/shared-types:
 *   import { UnifiedPicksRow, BridgeOutboxRow } from '@unit-talk/shared-types';
 */
