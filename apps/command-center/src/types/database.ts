 ...
 * Canonical Row types are exported from @unit-talk/contracts.
 ...
 *
 * For now, apps should import canonical Row types from @unit-talk/contracts:
 *   import { UnifiedPicksRow, BridgeOutboxRow } from '@unit-talk/contracts';
 */
