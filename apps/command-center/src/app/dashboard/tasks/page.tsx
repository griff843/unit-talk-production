...
const tasks = [
  {
    ...
    description:
      "Analyze and grade pending MLB picks for tonight's games, focusing on player prop accuracy",
  ...
  },
  {
    ...
    description:
      'Create standard operating procedure document for weekly capper performance analysis',
    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Pre-configured task templates for common operations</CardDescription>
        </CardHeader>
        <CardContent>
