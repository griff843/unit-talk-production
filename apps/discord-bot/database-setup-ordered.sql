-- Unit Talk Discord Bot - Database Setup (Step by Step)
-- Copy and paste this ENTIRE script into Supabase SQL Editor and click RUN

-- STEP 1: Create core tables first (no foreign key dependencies)
...
-- STEP 2: Create tables that depend on user_profiles
...
CREATE TABLE IF NOT EXISTS contest_participants (
    ...
    professional_score DECIMAL(10,2) DEFAULT 0,
    rank INTEGER,
...
INSERT INTO onboarding_flows (
    ...
    '[{"id": 1, "type": "welcome", "title": "Welcome to Unit Talk!", "description": "Thanks for joining our community"}, {"id": 2, "type": "role_assignment", "title": "Role Assignment", "description": "Getting your member role"}, {"id": 3, "type": "channel_introduction", "title": "Channel Tour", "description": "Learn about our channels"}]'::jsonb,
    true
) ON CONFLICT DO NOTHING;
