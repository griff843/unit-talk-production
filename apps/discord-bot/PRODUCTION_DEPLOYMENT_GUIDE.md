...
This guide provides step-by-step instructions for deploying the Unit Talk
Discord Bot to a production environment with enterprise-grade monitoring,
...
2. **Customize Alert Rules** Edit `config/prometheus/rules/alerts.yml` for
   custom thresholds
