...
This document describes the AI coaching functionality integrated into the Unit
Talk Discord bot, providing personalized betting analysis and coaching sessions.

## Overview

The AI coaching system provides:

- **Personalized Analysis**: AI-powered betting analysis based on user history
  and tier
- **Session Management**: Persistent coaching sessions with Q&A tracking
- **Tier-Based Features**: Different analysis depth based on user subscription
  tier
