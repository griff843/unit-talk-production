...
const FAQ_DATA: FAQItem[] = [
  {
    ...
    icon: '🏆',
    description:
      "Unit Talk is the premier Discord for sports bettors, blending expert analysis, daily picks, and education from pro handicappers. Whether you're learning or looking for a sharp edge, you'll find elite insights and a winning community here.",
    button_label: null,
    button_url: null,
  },
  {
    ...
    icon: '💎',
    description:
      "Subscribing unlocks all VIP channels—live picks, in-depth strategies, private analytics, and daily breakdowns direct from the pros. You'll get real-time alerts, member-only contests, and access to our premium tools and support.",
  ...
  },
  {
    ...
    icon: '🕒',
    description:
      'Yes! Try VIP for just $1 for your first week. Get full access to every premium channel and tool—no risk, cancel anytime.',
  ...
  },
  {
    ...
    icon: '💳',
    description:
      'We process all payments securely via Whop.com, supporting major credit/debit cards and several digital wallets. All details are encrypted and never stored by us.',
    button_label: null,
    button_url: null,
  },
  {
    ...
    icon: '🔓',
    description:
      "Yes! Free members get access to general chat, community picks, and educational resources. Explore, learn, and connect—upgrade only when you're ready for full VIP.",
  ...
  },
  {
    ...
    icon: '❌',
    description:
      "Absolutely—cancel anytime, no questions asked. Go to 'Manage Subscriptions' in your account, or open a support ticket for is_instant help.",
  ...
  },
  {
    ...
    icon: '📅',
    description:
      "You'll receive daily tips during all active sports seasons, and as soon as our cappers find value. Never miss a pick—enable thread notifications!",
  ...
  },
  {
    ...
    icon: '🏈',
    description:
      'Unit Talk covers football, basketball, baseball, hockey, and more. Our team includes specialists for each sport, so you always get the sharpest picks where it matters most.',
    button_label: null,
    button_url: null,
  },
  {
    ...
    icon: '🛠️',
    description:
      'We offer 24/7 support—open a ticket anytime, and our team will help fast. For common questions, check this FAQ or DM @Staff.',
  ...
  },
  {
    ...
    icon: '🔔',
    description:
      "Follow your favorite capper's thread in Capper Corner and enable notifications. Get every pick as it drops—never miss a win.",
  ...
  },
  {
    ...
    icon: '🛡️',
    description:
      'Yes. We never store your payment info, and all chats are private within Discord. For details, see our Privacy Policy.',
  ...
  },
  {
    ...
    icon: '🧠',
    description:
      'We encourage responsible betting and provide resources for support. Know your limits and always play for fun. For help, visit our Responsible Gaming page.',
...
export async function execute(interaction: ChatInputCommandInteraction) {
  try {
        ...
        if ((i + 1) % 3 === 0 || i === FAQ_DATA.length - 1) {
          const progressEmbed = new EmbedBuilder()
            ...
            .addFields(
              ...
              {
                name: '📊 Progress',
                value: `${Math.round(((i + 1) / FAQ_DATA.length) * 100)}%`,
                inline: true,
              }
            )
            .setColor('#1EF763')
    ...
    logger.info(
      `FAQ initialization completed by ${interaction.user.tag}: ${successCount} success, ${errorCount} errors`
    );
  } catch (error) {
    logger.error('Error in faq-init command:', error);

    const errorMessage =
      '❌ An error occurred during FAQ initialization. Please check the logs and try again.';
