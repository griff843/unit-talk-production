...
module.exports = {
  data: new SlashCommandBuilder()
    ...
    .addUserOption(option =>
      option
        .setName('user')
        .setDescription(`User to display the punishment history`)
        .setRequired(true)
    ),
  ...
  async execute(interaction, client) {
    ...
    const nopermEmbed = new EmbedBuilder()
      .setDescription(
        `You don't have permissions to run this command. You need \`Manage Channels\` permission to run this command!`
      )
      .setColor(`Red`);
