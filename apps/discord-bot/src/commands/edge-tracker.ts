...
export const data = new SlashCommandBuilder()
  ...
  .addSubcommand(subcommand =>
    subcommand.setName('overview').setDescription('View your overall betting performance')
  )
  .addSubcommand(subcommand =>
    subcommand
      .setName('sport')
  ...
  .addSubcommand(subcommand =>
    subcommand.setName('trends').setDescription('View your betting trends and patterns')
  )
  .addSubcommand(subcommand =>
    subcommand.setName('goals').setDescription('Set and track your betting goals')
  );
      ...
      const embed = new EmbedBuilder()
        ...
        .addFields(
          ...
          },
          {
            name: '⭐ VIP Benefits',
            value:
              'VIP members get basic performance tracking. Upgrade to VIP+ for advanced analytics and edge tracking!',
            inline: false,
          }
        );
