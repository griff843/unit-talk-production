...
module.exports = client => {
    ...
    if (oldState.channel && !newState.channel) {
      ...
      const embed = new EmbedBuilder()
        ...
        .setAuthor({
          name: 'CHANNEL LEFT',
          iconURL:
            'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS07YilaV52XGoxo78bYImjMSPMmybpec5Qiw&usqp=CAU',
        })
        .setDescription(
          `**User:** <@${oldState.member.id}> (ID: ${oldState.member.id})
            \n**Channel:** <#${oldState.channel.id}> (ID: ${oldState.channel.id})`
        )
        .setThumbnail(
          'https://discords.com/_next/image?url=https%3A%2F%2Fcdn.discordapp.com%2Femojis%2F876897427242766356.gif%3Fv%3D1&w=128&q=75'
        )
        .setTimestamp();
  ...
  client.on('voiceStateUpdate', async (oldState, newState) => {
    if (!oldState.channel && newState.channel) {
      ...
      const embed = new EmbedBuilder()
        ...
        .setDescription(
          `**User:** <@${newState.member.id}> (ID: ${newState.member.id})
  ...
  client.on('voiceStateUpdate', async (oldState, newState) => {
    if (oldState.channel && newState.channel && oldState.channel.id !== newState.channel.id) {
      ...
      const embed = new EmbedBuilder()
        ...
        .setDescription(
          `**User:** <@${newState.member.id}> (${newState.member.user.tag}) (ID: ${newState.member.id})
            \n**TO CHANNEL:** <#${newState.channel.id}> (ID: ${newState.channel.id})
            \n**FROM CHANNEL:** <#${oldState.channel.id}> (ID: ${oldState.channel.id})`
        )
        .setThumbnail(
          'https://cdn.discordapp.com/attachments/849047781276647425/869529684805840896/841989410978398218.gif?ex=65af979f&is=659d229f&hm=9fb59e190a49ca05bb9271f0518c1473983dbe4667ebf468b60bcca761c53b4f&'
        )
  ...
  client.on('messageDelete', async message => {
    ...
    const embed = new EmbedBuilder()
      ...
      .addFields(
        {
          name: 'Author',
          value: `@${message.author.tag || 'Cannot determine'} - ${message.author || 'Cannot determine'}`,
          inline: true,
        },
  ...
  client.on('roleDelete', async role => {
    ...
    const embed = new EmbedBuilder()
      ...
      .setThumbnail(
        'https://discords.com/_next/image?url=https%3A%2F%2Fcdn.discordapp.com%2Femojis%2F804032068841242705.png%3Fv%3D1&w=128&q=75'
      )
      .setTimestamp();
    ...
    const embed = new EmbedBuilder()
      ...
      .addFields(
        ...
        { name: 'Channel', value: `${newMessage.channel}`, inline: true },
        {
          ...
          value: oldMessage.content ? oldMessage.content : 'No original text',
          inline: false,
        },
        {
          name: 'Edited Message',
          value: newMessage.content ? newMessage.content : 'No edited text',
          inline: false,
        }
      )
      .addFields({
        name: 'Jump to Message',
        value: `[Click here to jump to the message](${messageLink})`,
        inline: false,
      })
      .setThumbnail(
        'https://discords.com/_next/image?url=https%3A%2F%2Fcdn.discordapp.com%2Femojis%2F944017636893786203.png%3Fv%3D1&w=128&q=75'
      )
      .setTimestamp();
  ...
  client.on('guildMemberUpdate', async (oldMember, newMember) => {
    ...
    if (addedRole) {
      ...
      const embed = new EmbedBuilder()
        ...
        .setThumbnail(
          'https://discords.com/_next/image?url=https%3A%2F%2Fcdn.discordapp.com%2Femojis%2F812353578995679324.png%3Fv%3D1&w=128&q=75'
        )
        .setTimestamp();
  ...
  client.on('guildMemberUpdate', async (oldMember, newMember) => {
    ...
    if (removedRole) {
      ...
      const embed = new EmbedBuilder()
        ...
        .setThumbnail(
          'https://discords.com/_next/image?url=https%3A%2F%2Fcdn.discordapp.com%2Femojis%2F904899961961984011.png%3Fv%3D1&w=128&q=75'
        )
        .setTimestamp();
  ...
  client.on('inviteCreate', async invite => {
    ...
    const embed = new EmbedBuilder()
      ...
      .addFields(
        ...
        {
          name: 'Expires',
          value: invite.expiresTimestamp ? new Date(invite.expiresTimestamp).toString() : 'Never',
          inline: true,
        },
  ...
  client.on('roleUpdate', async (oldRole, newRole) => {
    ...
    if (descriptionText !== '') {
      const embed = new EmbedBuilder()
        ...
        .setTimestamp()
        .setThumbnail(
          'https://discords.com/_next/image?url=https%3A%2F%2Fcdn.discordapp.com%2Femojis%2F769686808375590943.gif%3Fv%3D1&w=128&q=75'
        )
        .setTimestamp();
      logChannel.send({ embeds: [embed] }).catch(console.error);
    }
  ...
  client.on('emojiCreate', async emoji => {
    ...
    const fetchedLogs = await emoji.guild
      .fetchAuditLogs({
        limit: 1,
  ...
  client.on('emojiDelete', async emoji => {
    ...
    const embed = new EmbedBuilder()
      ...
      .setThumbnail(
        'https://discords.com/_next/image?url=https%3A%2F%2Fcdn.discordapp.com%2Femojis%2F893811882807410759.gif%3Fv%3D1&w=128&q=75'
      )
      .addFields(
        { name: 'Emoji Name', value: `\`${emoji.name}\``, inline: true },
        { name: 'Emoji ID', value: `\`${emoji.id}\``, inline: true },
  ...
  client.on('emojiUpdate', async (oldEmoji, newEmoji) => {
    ...
    const fetchedLogs = await newEmoji.guild
      .fetchAuditLogs({
        limit: 1,
  ...
  client.on('channelCreate', async channel => {
    ...
    const embed = new EmbedBuilder()
      ...
      .setThumbnail(
        'https://discords.com/_next/image?url=https%3A%2F%2Fcdn.discordapp.com%2Femojis%2F1000566451213701180.gif%3Fv%3D1&w=128&q=75'
      )
      .addFields(
  ...
  client.on('messageDeleteBulk', async messages => {
    ...
    const fetchedLogs = await messages
      .first()
  ...
  client.on('guildMemberAdd', async member => {
    ...
    if (accountAge < sevenDaysInMilliseconds) {
      accountAgeWarning =
        '⚠️ **This account is less than 7 days old. Admins, please take note!** ⚠️';
    }
    ...
    const embed = new EmbedBuilder()
      ...
      .setDescription(
        `Member ${member.user.tag} Account overview! 
  ...
  client.on('guildBanAdd', async ban => {
    ...
    const embed = new EmbedBuilder()
      ...
      .addFields(
        ...
        {
          name: 'Time of ban',
          value: `<t:${Math.floor(banLog.createdTimestamp / 1000)}:F>`,
          inline: false,
        }
      );
    ...
    try {
      ...
      const embed = new EmbedBuilder()
        ...
        .addFields(
          ...
          {
            name: 'Time of Kick',
            value: `<t:${Math.floor(kickLog.createdTimestamp / 1000)}:F>`,
            inline: false,
          }
        );
