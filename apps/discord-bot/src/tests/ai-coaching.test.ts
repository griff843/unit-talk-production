...
async function testAICoaching() {
  ...
  try {
    ...
    await aiCoachingService.addQuestionToSession(sessionId, analysisRequest.question, analysis);
    ...
    try {
      ...
      await aiCoachingService.addQuestionToSession('invalid_session_id', 'Test question', analysis);
