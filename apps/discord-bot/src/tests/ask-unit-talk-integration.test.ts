...
describe('ask-unit-talk Integration Tests', () => {
  ...
  describe('AI Analysis Generation', () => {
    ...
    it('should provide different analysis quality based on user tier', async () => {
      ...
      expect(vipPlusAnalysis.followUpQuestions.length).toBeGreaterThanOrEqual(
        vipAnalysis.followUpQuestions.length
      );
    });
  ...
  describe('Error Handling and Resilience', () => {
    it('should handle AI service failures gracefully', async () => {
      ...
      (aiCoachingService as any).generateAnalysis = jest
        .fn()
  ...
  describe('Context Processing', () => {
    it('should properly parse and use context information', async () => {
      ...
      expect(analysis.analysis.toLowerCase()).toMatch(
        /nba|basketball|game|tonight|injury|injuries/
      );
    });
