...
export const ONBOARDING_PROMPTS = {
  ...
  WELCOME_MESSAGES: {
    VIP: {
      ...
      description:
        "You now have access to premium picks, exclusive channels, and priority support. Let's get you started!",
      color: 0xffd700, // Gold
      fields: [
        {
          name: '🏆 VIP Benefits',
          value:
            '• Access to all capper picks\n• Exclusive VIP channels\n• Priority customer support\n• Advanced analytics\n• Early access to new features',
          inline: false,
        },
        {
          name: '📍 Next Steps',
          value:
            '1. Check out <#capper-corner> for daily picks\n2. Enable notifications for your favorite cappers\n3. Join the VIP discussion in <#vip-lounge>',
          inline: false,
        },
      ],
      buttons: [
    ...
    PREMIUM: {
      ...
      description:
        'You have access to premium features and select capper picks. Welcome to the community!',
      color: 0x9932cc, // Purple
      fields: [
        {
          name: '💎 Premium Benefits',
          value:
            '• Access to premium capper picks\n• Premium channels access\n• Enhanced support\n• Weekly analytics reports',
          inline: false,
        },
      ],
      buttons: [
    ...
    TRIAL: {
      ...
      description:
        'Welcome to the Unit Talk community! Start your journey with our expert picks and analysis.',
    ...
    CAPPER: {
      ...
      description:
        "You've been granted capper privileges! Time to start submitting picks and building your reputation.",
      ...
      fields: [
        ...
        },
        {
          ...
          value:
            'All your picks are automatically tracked for wins, losses, ROI, and leaderboard rankings.',
          inline: false,
        },
      ],
      buttons: [
  ...
  blackLabelFeatures: {
    embed: {
      ...
      fields: [
        ...
        {
          name: '📱 Premium Alerts',
          value: 'SMS notifications and is_instant alerts for all top plays',
          inline: false,
        },
        {
