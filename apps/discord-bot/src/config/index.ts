  ...
  env = {
    discord: {
      ...
      channels: {
        ...
        vipPlusExclusiveInsights: process.env.VIP_PLUS_EXCLUSIVE_INSIGHTS_CHANNEL_ID || '',
        vipPlusTraderInsights: process.env.VIP_PLUS_TRADER_INSIGHTS_CHANNEL_ID || '',
        cappersSpace: process.env.CAPPERS_SPACE_CHANNEL_ID || process.env.VIP_GENERAL_CHANNEL_ID || '',
      ...
      roles: {
        vip: [process.env.ROLE_VIP_ID || (process.env.VIP_ROLE_IDS || '').split(',')[0] || ''],
        vipPlus: [process.env.ROLE_VIP_PLUS_ID || (process.env.VIP_PLUS_ROLE_IDS || '').split(',')[0] || ''],
        trial: [process.env.ROLE_TRIAL_ID || (process.env.TRIAL_ROLE_IDS || '').split(',')[0] || ''],
        staff: [process.env.ROLE_STAFF_ID || (process.env.STAFF_ROLE_IDS || '').split(',')[0] || ''],
        admin: [process.env.ROLE_ADMIN_ID || (process.env.ADMIN_ROLE_IDS || '').split(',')[0] || ''],
        owner: [process.env.ROLE_OWNER_ID || (process.env.OWNER_ROLE_IDS || '').split(',')[0] || ''],
        moderator: [process.env.ROLE_MODERATOR_ID || (process.env.MODERATOR_ROLE_IDS || '').split(',')[0] || ''],
      },
    },
    features: {
...
export const botConfig: BotConfig = {
  ...
  channels: {
    ...
    vipPlusExclusiveInsights: (env.discord.channels as any).vipPlusExclusiveInsights,
    vipPlusTraderInsights: (env.discord.channels as any).vipPlusTraderInsights,
    cappersSpace: (env.discord.channels as any).cappersSpace,
    threads: env.discord.channels.threads,
  },
  roles: {
    member: env.discord.roles.vip[0] || '', // Using VIP role as member fallback
    trial: env.discord.roles.trial[0] || '',
