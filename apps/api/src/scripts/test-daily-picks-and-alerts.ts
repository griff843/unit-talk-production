    ...
    return [
      ...
      ['MoneyReef', {
        ...
        metadata: {
          testType: 'daily_pick',
          testRun: true,
          analysis: 'High-scoring potential with both teams averaging 28+ PPG. Chiefs undefeated at home.'
        }
      }],
      ...
      ['Griff843', {
        ...
        metadata: {
          testType: 'daily_pick',
          testRun: true,
          analysis: 'Cole on the mound at home, Yankees 12-3 in first 5 innings with Cole starting'
        }
      }],
