    ...
    return [
      ...
      ['KingRo623', {
        ...
        metadata: {
          ...
          testRun: true,
          analysis: 'Celtics 8-2 ATS at home vs Western Conference teams. Key advantage in pace differential (+4.2 possessions/game) and defensive rating improvement (108.3 → 104.1 in last 10).',
          edgeScore: 12.4,
          expectedValue: 8.7,
          kellyFraction: 2.3,
          riskScore: 4.2,
      ...
      ['MoneyReef', {
        ...
        metadata: {
          testType: 'enhanced_daily_pick',
          testRun: true,
          analysis: 'Chiefs undefeated at home (7-0) with Mahomes averaging 312 pass yards. Weather favorable for passing (72°F, 3mph winds). Total correlation analysis shows 0.31 positive correlation between Chiefs ML and Over.',
          edgeScore: 15.8,
          expectedValue: 11.2,
          kellyFraction: 1.8,
          riskScore: 6.7,
      ...
      ['Griff843', {
        ...
        metadata: {
          testType: 'enhanced_daily_pick',
          testRun: true,
          analysis: 'Cole (3.21 ERA) dominant in first 5 innings at home: 1.89 ERA, 0.94 WHIP, 12.1 K/9. Yankees lineup vs RHP: .847 OPS (3rd in MLB). Opposing starter allows 5.2 runs in F5 over last 6 starts.',
          edgeScore: 18.6,
          expectedValue: 14.3,
          kellyFraction: 3.2,
          riskScore: 3.1,
      ...
      ['Griff843', {
        ...
        metadata: {
          ...
          testRun: true,
          analysis: 'Live adjustment based on 1H metrics: Both teams shooting 39% (well below season avg of 47%). Pace dropped to 95.2 possessions (from 101.3 pregame). Key players in foul trouble affecting rotation.',
          edgeScore: 13.7,
          expectedValue: 9.4,
          kellyFraction: 2.1,
          riskScore: 5.3,
...
if (require.main === module) {
  ...
  testRunner.runEnhancedTests()
    .then(() => {
      ...
      logger.info('   🧠 AI Insights: Model agreement, feature contributions, correlation analysis');
