...
import {
  ...
  getRoutingInfo,
  getSystemStatus,
} from '../agents/FeedAgent/dataSourceRouter';
...
async function testOptimalApiIntegration() {
  ...
  try {
    ...
    try {
      ...
      console.log(
        `❌ NBA test failed: ${error instanceof Error ? error.message : 'Unknown error'}`
      );
    }
    ...
    try {
      ...
      console.log(
        `❌ NFL test failed: ${error instanceof Error ? error.message : 'Unknown error'}`
      );
    }
    ...
    try {
      ...
      console.log(
        `❌ NCAAF test failed: ${error instanceof Error ? error.message : 'Unknown error'}`
      );
    }
    ...
    try {
      ...
      console.log(
        `⚠️ Rate limit status unavailable: ${error instanceof Error ? error.message : 'Unknown error'}`
      );
    }
