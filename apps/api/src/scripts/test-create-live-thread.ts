...
async function createTodaysGameThread() {
  ...
  try {
    ...
    const realCapperPick = {
      ...
      reasoning: 'Bills at home in championship game are different. Josh Allen has been elite in playoffs, Bills defense playing lights out. Mahomes struggles in Buffalo cold weather. This is Bills\' year.',
    ...
    console.log(`   📂 Thread Name: "🏈 ${realTodayGame.teams} - ${new Date().toLocaleDateString()}"`);
    console.log(`   🆔 Thread ID: [would be auto-generated]`);
    console.log(`   📍 Location: #game-day-live channel (${process.env.GAME_DAY_LIVE_CHANNEL || '1291234713213734912'})`);
    ...
    const capperPickEmbed = {
      ...
      fields: [
        ...
        },
        {
          ...
          value: 'Bills at home in championship game are different. Josh Allen has been elite in playoffs, Bills defense playing lights out. Mahomes struggles in Buffalo cold weather. This is Bills\' year.',
          inline: false
        }
      ],
