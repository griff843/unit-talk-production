...
export const MLB_WEIGHTS: SportSpecificWeights = {
  ...
  lineMovement: 0.1, // Moderate importance
  ...
  closingLineValue: 0.1, // CLV still important
...
export const MLB_RISK: RiskManagementConfig = {
  ...
  maxDrawdown: 0.2, // Higher tolerance for baseball variance
  maxCorrelation: 0.7, // Higher correlation tolerance
  minSharpeRatio: 0.9, // Lower Sharpe requirement (higher variance)
  maxExposurePerSport: 0.3, // Standard sport exposure
  maxExposurePerPlayer: 0.1, // Player exposure limit
