...
export const CONSERVATIVE_RISK_PROFILE: Partial<RiskProfile> = {
...
export const MODERATE_RISK_PROFILE: Partial<RiskProfile> = {
...
export const AGGRESSIVE_RISK_PROFILE: Partial<RiskProfile> = {
...
export class RiskManagementConfigFactory {
  ...
  static createConfig(overrides?: Partial<RiskManagementConfig>): RiskManagementConfig {
    const baseConfig: RiskManagementConfig = {
      kelly: DEFAULT_KELLY_CONFIG,
...
export const PRODUCTION_CONFIG = RiskManagementConfigFactory.getProductionConfig();
export const DEVELOPMENT_CONFIG = RiskManagementConfigFactory.getDevelopmentConfig();
