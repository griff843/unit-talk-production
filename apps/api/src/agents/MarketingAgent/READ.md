...
Automates all marketing campaigns, referral programs, and engagement tracking
for Unit Talk. Integrates with Supabase and exposes event hooks for
Discord/Notion.
...
- `onCampaignCreated`, `onReferralUpdated`, `onEngagementReported` – connect to
  Discord, Notion, or Retool
...
const agent = new MarketingAgent(
  { agentName: 'MarketingAgent', enabled: true },
  supabase
);
