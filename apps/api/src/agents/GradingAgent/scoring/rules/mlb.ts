...
export const enhancedMLBWeights = {
...
export const mlbContextualMultipliers = {
...
export const handednessAdvantages = {
  L_vs_R: 1.12, // Lefty batter vs righty pitcher (generally favorable)
  R_vs_L: 1.1, // Righty batter vs lefty pitcher (can be advantageous)
