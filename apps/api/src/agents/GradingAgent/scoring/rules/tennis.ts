export const tennisCoreStats = ['aces', 'double_faults', 'first_serve_percentage', 'break_points_saved', 'games_won'];
export const tennisSynergy: Record<string, string[]> = {
...
export const enhancedTennisWeights = {
...
export const tennisContextualMultipliers = {
...
export const tennisSurfaceFactors = {
...
export const tennisMatchupFactors = {
  headToHeadAdvantage: {
...
export const tennisPhysicalFactors = {
  fitnessLevel: {
...
export const tennisTournamentFactors = {
