...
export class RiskManager {
   ...
   */
  private isSameGame(_prop1: any, _prop2: Position): boolean {
  ...
  private estimateVolatility(_prop: any): number {
  ...
  private async calculatePortfolioVaR(_positions: Position[]): Promise<number> {
