...
export const ScoringAgentConfigSchema = z.object({
...
export function validateScoringConfig(data: unknown): ScoringAgentConfig {
  return ScoringAgentConfigSchema.parse(data);
}