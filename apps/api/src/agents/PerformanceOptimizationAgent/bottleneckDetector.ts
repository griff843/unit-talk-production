...
export class BottleneckDetector {
  ...
  private generateRecommendations(type: string, severity: string, _value: number): string[] { // Value unused in recommendations
  ...
  private detectCompositeBottlenecks(metrics: PerformanceMetrics, timestamp: Date): PerformanceBottleneck | null {
