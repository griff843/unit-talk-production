...
export interface PerformancePatterns {
  sportPerformance: Map<string, { correct: number; total: number }>;
  marketPerformance: Map<string, { correct: number; total: number }>;
  confidencePerformance: Map<string, { correct: number; total: number }>;
  timeOfDayPerformance: Map<string, { correct: number; total: number }>;
}
