...
import { execute, handlePickTypeSelect, handleSinglePickModal, handleParlayPickModal, handlePickConfirmation } from '../../src/commands/submit-pick';
...
describe('submit-pick command', () => {
  ...
  describe('handleSinglePickModal', () => {
    ...
    it('should validate units input', async () => {
      modalInteraction.fields.getTextInputValue = jest.fn()
