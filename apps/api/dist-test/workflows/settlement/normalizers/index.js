...
exports.getSupportedMarkets = getSupportedMarkets;
const logger_1 = require("../../../utils/logger");
const logger = (0, logger_1.createLogger)('MarketNormalizer');
/**
 ...
 */
function normalizeMarket(league, market, playerStats) {
...
function normalizeMLB(market, stats) {
...
function normalizeNFL(market, stats) {
    const marketUpper = market.toUpperCase().replace(/[\s_-]/g, '');
    switch (marketUpper) {
        // Passing markets
        case 'PASSINGYARDS':
...
function normalizeNBA(market, stats) {
    const marketUpper = market.toUpperCase().replace(/[\s_-]/g, '');
    switch (marketUpper) {
        // Basic stats
        case 'POINTS':
...
function normalizeNCAA(market, stats) {
...
function normalizeWNBA(market, stats) {
 ...
 */
function getSupportedMarkets(league) {
    switch (league.toUpperCase()) {
        case 'MLB':
            return [
