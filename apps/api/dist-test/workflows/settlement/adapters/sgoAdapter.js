 ...
 */
class SgoAdapter extends types_1.BaseAdapter {
    constructor() {
        super();
        this.baseUrl = 'https://api.sportsgameodds.com/v2';
        this.logger = (0, logger_1.createLogger)('SgoAdapter');
    ...
    async fetchGameStats(gameId) {
        return this.retryWithBackoff(async () => {
            try {
                ...
                const gameResponse = await axios_1.default.get(`${this.baseUrl}/games/${gameId}`, {
                    headers: {
                ...
                const statsResponse = await axios_1.default.get(`${this.baseUrl}/games/${gameId}/results`, {
                    headers: {
                        'x-api-key': this.apiKey,
                        'User-Agent': 'UnitTalk/1.0 Settlement System'
                    },
     ...
     */
    parseSgoStatsResponse(data, sport) {
        const playerStats = {};
        try {
     ...
     */
    addCompositeStats(playerStats, sport) {
