...
exports.FeatureBuilderWorkflow = FeatureBuilderWorkflow;
exports.ScheduledFeatureBuilderWorkflow = ScheduledFeatureBuilderWorkflow;
exports.ExpressFeatureBuilderWorkflow = ExpressFeatureBuilderWorkflow;
 ...
 */
async function FeatureBuilderWorkflow(params) {
    ...
    try {
        ...
        if (computeAll || features.some(f => f.includes('rolling') || f.includes('trend'))) {
            ...
            const rollingResult = await activities.computeRollingFeatures({
                lookbackHours,
                batchSize,
                features: features.filter(f => f.includes('rolling') || f.includes('trend') || f.includes('momentum'))
            });
 ...
 */
async function ScheduledFeatureBuilderWorkflow() {
 ...
 */
async function ExpressFeatureBuilderWorkflow(params) {
...
//# sourceMappingURL=FeatureBuilderWorkflow.js.map