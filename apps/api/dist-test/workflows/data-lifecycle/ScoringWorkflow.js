...
exports.ScoringWorkflow = ScoringWorkflow;
exports.ScheduledScoringWorkflow = ScheduledScoringWorkflow;
exports.ExpressScoringWorkflow = ExpressScoringWorkflow;
 ...
 */
async function ScoringWorkflow(params) {
    ...
    try {
        ...
        scoringResult.results.forEach(r => {
            result.gradeDistribution[r.grade]++;
 ...
 */
async function ScheduledScoringWorkflow() {
 ...
 */
async function ExpressScoringWorkflow(params) {
...
//# sourceMappingURL=ScoringWorkflow.js.map