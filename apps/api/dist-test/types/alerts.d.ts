...
export type AlertChannel = 'discord' | 'notion' | 'retool' | 'email' | 'sms' | 'slack';
/** All supported alert types (add more as needed). */
export type AlertType = 'line_movement' | 'injury' | 'steam' | 'edge' | 'recap' | 'incident' | 'system' | 'hedge' | 'middling' | 'heat_signal' | 'parlay_opportunity' | 'clv' | 'trap_line' | 'sgp' | 'book_clipping' | 'custom';
