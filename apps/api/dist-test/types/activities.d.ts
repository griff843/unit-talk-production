...
export interface PlayerEnrichmentAgentActivities {
    ...
    enrichPlayerById(params: ActivityParams & {
        playerId: string;
    }): Promise<void>;
    getPlayerHeadshot(params: ActivityParams & {
        playerName: string;
        league: string;
    }): Promise<void>;
    getMlbHeadshot(params: ActivityParams & {
        playerName: string;
    }): Promise<void>;
    getNbaHeadshot(params: ActivityParams & {
        playerName: string;
    }): Promise<void>;
    getNflHeadshot(params: ActivityParams & {
        playerName: string;
    }): Promise<void>;
    getNhlHeadshot(params: ActivityParams & {
        playerName: string;
    }): Promise<void>;
}
