...
exports.AgentMonitoringIntegration = void 0;
const AutomatedOnboardingAgent_1 = require("../agents/AutomatedOnboardingAgent");
const PerformanceOptimizationAgent_1 = require("../agents/PerformanceOptimizationAgent");
const PredictiveAnalyticsAgent_1 = require("../agents/PredictiveAnalyticsAgent");
const RiskManagementAgent_1 = require("../agents/RiskManagementAgent");
const UserRetentionAgent_1 = require("../agents/UserRetentionAgent");
class AgentMonitoringIntegration {
    ...
    async collectAllAgentMetrics() {
        const collectionPromises = Array.from(this.registeredAgents.entries()).map(async ([agentName, agent]) => {
            try {
    ...
    async collectAgentMetrics(agentName, agent) {
    ...
    async getPerformanceMetrics(agent) {
    ...
    setupAgentEventListeners(agent) {
        ...
        if (agent instanceof AutomatedOnboardingAgent_1.AutomatedOnboardingAgent) {
            this.setupOnboardingAgentListeners(agent, agentName);
        }
        else if (agent instanceof UserRetentionAgent_1.UserRetentionAgent) {
            this.setupRetentionAgentListeners(agent, agentName);
        }
        else if (agent instanceof RiskManagementAgent_1.RiskManagementAgent) {
            this.setupRiskAgentListeners(agent, agentName);
        }
        else if (agent instanceof PredictiveAnalyticsAgent_1.PredictiveAnalyticsAgent) {
            this.setupPredictiveAgentListeners(agent, agentName);
        }
        else if (agent instanceof PerformanceOptimizationAgent_1.PerformanceOptimizationAgent) {
            this.setupPerformanceAgentListeners(agent, agentName);
        }
    }
    setupOnboardingAgentListeners(agent, agentName) {
    ...
    setupRetentionAgentListeners(agent, agentName) {
    ...
    setupRiskAgentListeners(agent, agentName) {
    ...
    setupPredictiveAgentListeners(agent, agentName) {
    ...
    setupPerformanceAgentListeners(agent, agentName) {
...
exports.AgentMonitoringIntegration = AgentMonitoringIntegration;
