...
const logger = (0, logger_1.createLogger)('GracefulShutdown');
class GracefulShutdownManager {
     ...
     */
    async initiateShutdown(signal, emergency = false) {
     ...
     */
    async executeShutdownHandlers(emergency) {
...
let gracefulShutdownManager = null;
function initializeGracefulShutdown(config) {
