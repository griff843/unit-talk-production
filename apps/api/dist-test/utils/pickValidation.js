...
exports.validatePickLeg = validatePickLeg;
exports.validateParlay = validateParlay;
exports.validateSubmissionTiming = validateSubmissionTiming;
 ...
 */
function validatePickLeg(leg, options = exports.DEFAULT_VALIDATION_OPTIONS) {
    const errors = [];
    const warnings = [];
 ...
 */
function validateParlay(legs, options = exports.DEFAULT_VALIDATION_OPTIONS) {
    const errors = [];
    const warnings = [];
    // Check parlay size
 ...
 */
function validateSubmissionTiming(eventDate, options = exports.DEFAULT_VALIDATION_OPTIONS) {
    const errors = [];
    const warnings = [];
    const now = new Date();
