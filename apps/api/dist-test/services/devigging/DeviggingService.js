...
class DeviggingService {
     ...
     */
    americanToImpliedProb(americanOdds) {
        if (americanOdds > 0) {
     ...
     */
    devigTwoWay(market, method = 'multiplicative') {
     ...
     */
    devigMultiWay(market, method = 'multiplicative') {
    ...
    shinFunction(z, probs, totalImplied) {
     ...
     */
    devigExchange(backOdds, layOdds, commission = 0.02) {
     ...
     */
    devigLive(market, gameProgress, // 0-1 (0 = start, 1 = end)
    baseVigMultiplier = 1.5 // Live typically has 50% higher vig
    ) {
     ...
     */
    calculateEdge(modelProb, marketOdds, includeKellyMultiplier = true) {
...
exports.DeviggingService = DeviggingService;
// Export singleton instance
exports.deviggingService = DeviggingService.getInstance();
