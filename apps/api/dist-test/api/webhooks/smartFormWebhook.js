...
exports.smartFormWebhookHandler = exports.SmartFormWebhookHandler = void 0;
 ...
 */
class SmartFormWebhookHandler {
    constructor() {
        this.bridge = new SmartFormBridge_1.SmartFormBridge();
    }
    /**
     * Handle webhook from Supabase on smart_tickets INSERT
     */
    async handleWebhook(req, res) {
        const webhookLogger = logger_1.logger.child({ source: 'smart_form_webhook' });
        try {
     ...
     */
    isValidWebhook(type, table, record) {
     ...
     */
    async processSubmissionAsync(ticketId, webhookLogger) {
        try {
...
exports.SmartFormWebhookHandler = SmartFormWebhookHandler;
// Export the handler instance
exports.smartFormWebhookHandler = new SmartFormWebhookHandler();
