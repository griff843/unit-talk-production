 ...
 */
async function executeProbe(scriptPath) {
    return new Promise((resolve) => {
        const fullPath = path_1.default.resolve(process.cwd(), '../..', scriptPath);
        const child = (0, child_process_1.spawn)('npx', ['tsx', fullPath], {
 ...
 */
router.post('/health', auth_1.requireOpsKey, async (req, res) => {
 ...
 */
router.post('/temporal', auth_1.requireOpsKey, async (req, res) => {
 ...
 */
router.post('/database', auth_1.requireOpsKey, async (req, res) => {
