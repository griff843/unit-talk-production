...
const SLOMonitoringService_1 = __importDefault(require("../services/monitoring/SLOMonitoringService"));
const IncidentManagementService_1 = __importDefault(require("../services/monitoring/IncidentManagementService"));
const OperatorDashboardService_1 = __importDefault(require("../services/monitoring/OperatorDashboardService"));
const auth_1 = require("../middleware/auth");
const express_rate_limit_1 = require("express-rate-limit");
const router = (0, express_1.Router)();
const logger = (0, logger_1.createLogger)('OperatorDashboardAPI');
const metrics = metrics_1.Metrics.getInstance();
// Initialize services
const sloService = new SLOMonitoringService_1.default();
const incidentService = new IncidentManagementService_1.default();
const dashboardService = new OperatorDashboardService_1.default(sloService, incidentService);
// Rate limiting for critical operations
const criticalOperationsLimit = (0, express_rate_limit_1.rateLimit)({
...
const systemControlsLimit = (0, express_rate_limit_1.rateLimit)({
 ...
 */
router.get('/slo/current', auth_1.requireAuth, async (req, res) => {
    try {
 ...
 */
router.get('/slo/error-budgets', auth_1.requireAuth, async (req, res) => {
    try {
 ...
 */
router.get('/slo/violations', auth_1.requireAuth, async (req, res) => {
    try {
 ...
 */
router.get('/incidents/active', auth_1.requireAuth, async (req, res) => {
    try {
 ...
 */
router.get('/incidents/:incidentId', auth_1.requireAuth, async (req, res) => {
    try {
 ...
 */
router.get('/incidents/:incidentId/timeline', auth_1.requireAuth, async (req, res) => {
    try {
        const { incidentId } = req.params;
 ...
 * Create new incident
 */
router.post('/incidents', auth_1.requireAuth, (0, auth_1.requireRole)(['operator', 'admin']), async (req, res) => {
    try {
 ...
 */
router.put('/incidents/:incidentId/status', auth_1.requireAuth, (0, auth_1.requireRole)(['operator', 'admin']), async (req, res) => {
    try {
        const { incidentId } = req.params;
 ...
 */
router.put('/incidents/:incidentId/assign', auth_1.requireAuth, (0, auth_1.requireRole)(['operator', 'admin']), async (req, res) => {
    try {
        const { incidentId } = req.params;
 ...
 */
router.post('/incidents/:incidentId/comments', auth_1.requireAuth, async (req, res) => {
    try {
        const { incidentId } = req.params;
 ...
 */
router.get('/controls', auth_1.requireAuth, (0, auth_1.requireRole)(['operator', 'admin']), async (req, res) => {
    try {
 ...
 * Toggle safe mode
 */
router.post('/controls/safe-mode', auth_1.requireAuth, (0, auth_1.requireRole)(['operator', 'admin']), systemControlsLimit, async (req, res) => {
    try {
 ...
 */
router.post('/controls/agents/:agentName', auth_1.requireAuth, (0, auth_1.requireRole)(['operator', 'admin']), systemControlsLimit, async (req, res) => {
    try {
 ...
 */
router.post('/controls/circuit-breakers/:serviceName', auth_1.requireAuth, (0, auth_1.requireRole)(['operator', 'admin']), systemControlsLimit, async (req, res) => {
    try {
 ...
 */
router.post('/controls/emergency-stop', auth_1.requireAuth, (0, auth_1.requireRole)(['admin']), criticalOperationsLimit, async (req, res) => {
    try {
 ...
 */
router.get('/analytics/performance', auth_1.requireAuth, async (req, res) => {
    try {
        const hours = parseInt(req.query.hours) || 24;
 ...
 */
router.get('/analytics/incidents', auth_1.requireAuth, async (req, res) => {
    try {
 ...
 */
router.get('/audit/actions', auth_1.requireAuth, (0, auth_1.requireRole)(['operator', 'admin']), async (req, res) => {
    try {
 ...
 */
router.get('/stream/events', auth_1.requireAuth, (req, res) => {
    ...
    const onSLOViolation = (violation) => {
        res.write(`data: ${JSON.stringify({
            type: 'slo_violation',
            data: violation,
            timestamp: new Date().toISOString()
    ...
    const onSystemControlChanged = (change) => {
        res.write(`data: ${JSON.stringify({
