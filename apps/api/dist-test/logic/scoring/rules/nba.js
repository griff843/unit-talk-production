...
exports.nbaCoreStats = nbaCoreStats;
exports.nbaSynergy = nbaSynergy;
/**
 * NBA Core Statistics Scoring
 * Evaluates fundamental basketball metrics
 */
function nbaCoreStats(prop) {
    const breakdown = {};
 ...
 */
function nbaSynergy(prop) {
    const breakdown = {};
    // Use line value professional_score as pace indicator
