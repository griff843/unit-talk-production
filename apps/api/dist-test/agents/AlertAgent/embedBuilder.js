...
exports.getPlayerHeadshotUrl = void 0;
exports.buildAlertEmbed = buildAlertEmbed;
exports.buildBatchAlertEmbed = buildBatchAlertEmbed;
const discord_js_1 = require("discord.js");
const parlayEmbedBuilder_1 = require("./parlayEmbedBuilder");
function getPickTypeEmoji(_marketType, isLive = false) {
    if (isLive)
        return '🔴';
    return '📊';
}
function getSystemGradeEmoji(tier) {
...
function getAlertPriority(pick) {
...
function buildAlertEmbed(pick, advice, playerImageUrl) {
    ...
    if (!headshotUrl && pick.player_name) {
        headshotUrl = (0, parlayEmbedBuilder_1.getPlayerHeadshotUrl)('', '', pick.player_name) || undefined;
    }
    if (headshotUrl) {
...
var parlayEmbedBuilder_2 = require("./parlayEmbedBuilder");
Object.defineProperty(exports, "getPlayerHeadshotUrl", { enumerable: true, get: function () { return parlayEmbedBuilder_2.getPlayerHeadshotUrl; } });
// Utility function for batch embed creation
function buildBatchAlertEmbed(picks, title = 'Daily Picks Summary') {
    const embed = new discord_js_1.EmbedBuilder()
        .setTitle(`📋 ${title}`)
        .setColor(0x0099FF)
        .setTimestamp();
