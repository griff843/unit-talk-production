...
exports.ParlayHedgeCalculator = void 0;
class ParlayHedgeCalculator {
    ...
    async calculateHedgeOpportunity(parlay) {
    ...
    async identifyActiveHedgeOpportunities(parlays) {
    ...
    async getHedgeRecommendation(parlay) {
        const result = await this.calculateHedgeOpportunity(parlay);
        if (!result.shouldHedge || !result.hedgeOpportunity) {
            return {
                action: 'let_ride',
    ...
    async calculateOptimalHedge(parlay, remainingLeg, completedLegs) {
    ...
    getOpposingSelection(selection, betType) {
    ...
    determineRecommendation(guaranteedProfit, originalStake, efficiency) {
    ...
    calculateConfidence(efficiency, profit, stake) {
    ...
    async analyzeHedgeScenarios(parlay, hedge) {
...
exports.ParlayHedgeCalculator = ParlayHedgeCalculator;
