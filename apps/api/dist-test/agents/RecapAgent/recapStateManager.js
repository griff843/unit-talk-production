...
exports.RecapStateManager = void 0;
/**
...
class RecapStateManager {
     ...
     */
    constructor(supabase, logger, options = {}) {
    ...
    async loadState() {
        try {
            ...
            const state = data.state_data || this.getDefaultState();
     ...
     * @returns Success indicator
     */
    async updateMicroRecapCooldown(cooldownMinutes = 5) {
        const now = new Date();
     ...
     * @returns Success indicator
     */
    async recordRecapRun(type, date) {
        const updates = {};
        switch (type) {
            case 'daily':
     ...
     * @returns Success indicator
     */
    async recordManualTrigger(type) {
        const state = await this.loadState();
...
exports.RecapStateManager = RecapStateManager;
