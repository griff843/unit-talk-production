...
class RecapFormatter {
     ...
     */
    buildDailyRecapEmbed(summary, parlayGroups = []) {
     ...
     */
    buildMonthlyRecapEmbed(summary) {
        const embed = new discord_js_1.EmbedBuilder()
     ...
     */
    buildMicroRecapEmbed(microData) {
        const embed = new discord_js_1.EmbedBuilder()
    ...
    buildCapperBreakdownText(cappers) {
    ...
    buildMonthlyHighlights(summary) {
        const highlights = [];
...
exports.RecapFormatter = RecapFormatter;
