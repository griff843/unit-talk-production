...
exports.analyzeBothSides = analyzeBothSides;
function calculateExpectedValue(prop) {
...
function analyzeBothSides(prop) {
...
function calculateSideEV(winProb, odds) {
    const payout = odds > 0 ? odds / 100 : 100 / Math.abs(odds);
    return (winProb * payout) - (1 - winProb);
}
function estimateProjectedProbability(prop, side) {
