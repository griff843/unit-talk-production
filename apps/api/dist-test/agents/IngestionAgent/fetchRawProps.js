...
exports.fetchRawProps = fetchRawProps;
const crypto_1 = require("crypto");
const dataSourceRouter_1 = require("../FeedAgent/dataSourceRouter");
 ...
 */
async function fetchRawProps(provider) {
    if (!provider.enabled) {
        return [];
    }
    try {
 ...
 */
async function fetchFromOptimal(_provider) {
    try {
 ...
 */
async function fetchFromSGO(_provider) {
 ...
 */
async function fetchFromOddsAPI(_provider) {
 ...
 */
async function fetchFromPinnacle(_provider) {
 ...
 */
async function fetchMockData(provider) {
