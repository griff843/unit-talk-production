...
exports.isDuplicateRawProp = isDuplicateRawProp;
exports.isDuplicateRawPropLegacy = isDuplicateRawPropLegacy;
exports.findDuplicateProps = findDuplicateProps;
exports.createDeduplicationKey = createDeduplicationKey;
/**
 ...
 */
async function isDuplicateRawProp(prop, supabase) {
    try {
 ...
 */
async function isDuplicateRawPropLegacy(_prop) {
 ...
 */
async function findDuplicateProps(prop, supabase) {
    try {
 ...
 */
function createDeduplicationKey(prop) {
    const keyParts = [
