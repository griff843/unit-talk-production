...
exports.validateRawProp = validateRawProp;
exports.validateRawPropDetailed = validateRawPropDetailed;
 ...
 */
function validateRawProp(prop) {
    try {
        types_1.RawPropSchema.parse(prop);
        return true;
    }
    catch {
        return false;
 ...
 */
function validateRawPropDetailed(prop) {
    try {
        types_1.RawPropSchema.parse(prop);
        return {
            isValid: true,
 ...
 */
function validateRequiredFields(prop) {
 ...
 */
function validateBusinessRules(prop) {
    const errors = [];
    const warnings = [];
