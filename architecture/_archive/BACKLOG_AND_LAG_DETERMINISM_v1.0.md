...
and outbound delivery MUST be halted until restored (per FREEZE_DETECTION_LAW /
...
Threshold is defined in SLO_DEFINITION.
...
Thresholds are defined in SLO_DEFINITION.
...
- All thresholds are referenced from SLO_DEFINITION
