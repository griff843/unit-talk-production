...
**Last Updated**: 2026-03-14 (SPRINT-DISCORD-GATEWAY-INTENTS-ENABLEMENT) **Audit
Sources**: SPRINT-DISCORD-GATEWAY-INTENTS-ENABLEMENT (GuildPresences intent
removed — gateway disconnection fixed; gatewayStatus.ts singleton added; health
split into discord_api + discord_gateway; deployment guide updated with explicit
...
| **Command Center**     | VERIFIED | READ-ONLY; health + ops-confidence + monitoring endpoints; Risk Engine dashboard with ExposureCard, DriftCard, EngineStatusCard, CorrelationPanel, DrawdownPanel; live `/api/risk/status` proxy + `/api/risk/decisions` proxy (SPRINT-RISK-DASHBOARD-MONITORING, PR #177)                                                                                                                                                                                                                                                                                                               | None                                                                                                                                                                                                                                                  |
...
| **CI/CD Pipeline**     | VERIFIED | Reusable workflows + lifecycle gate + R3 shadow guardrails + R4 fault suite wired; vitest 898/898; Jest 643/643 (35 suites, 0 quarantined — SPRINT-JEST-QUARANTINE-CLEANUP, 2026-03-14)                                                                                                                                                                                                                                                                                                                                                                                                 | None                                                                                                                                                                                                                                                  |
...
| Test Suite (Vitest)    | CLEAN         | 898/898 passing — scoped to `src/**/__tests__/` (+4 risk engine public method tests SPRINT-RISK-DASHBOARD-MONITORING, +101 Discord/Recap SPRINT-DISCORD-RECAP-VERIFICATION)                                                  |
