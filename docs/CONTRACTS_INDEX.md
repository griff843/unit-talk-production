...
| **contracts**     | `/packages/contracts/CLAUDE.md`     | Centralized TypeScript types and contracts |
| **shared**        | `/packages/shared/CLAUDE.md`        | Shared utilities, autopilot freeze         |
| **observability** | `/packages/observability/CLAUDE.md` | OpenTelemetry instrumentation              |
