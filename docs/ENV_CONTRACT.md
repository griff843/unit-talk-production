...
**Important**: Database variables are RUNTIME-ONLY. Builds MUST NOT require them.
...
**Warning**: NEXT_PUBLIC_* vars are embedded at BUILD TIME in Next.js.
Docker builds MUST provide these as build args or env vars.
...
- `CLAUDE_EXECUTION_CONTRACT.md` - Execution rules
