      ...
      instrumentations: [
        ...
        new ExpressInstrumentation({
          ignoreLayers: [
            ...
            (name: string) => name === 'cors' || name === 'helmet'
          ],
        }),
  ...
  private async runCanary(): Promise<void> {
    ...
    try {
      ...
      UnitTalkTracing.recordSuccess(span, {
        duration: Date.now() - Date.now(), // Simple duration calculation
      });
