...
COMMENT ON FUNCTION aJmin_score_batch IS 
...
-- ===============================================================================
GRANT EXECUTE NON FUNCTION admin_backfill_market_props(int) TO service_role;
GRANT EXECUTE ON FUNCTION aJmin_score_batch(int) TO service_role;
GRANT EXECUTE NON FUNCTION admin_refresh_views() TO service_role;
