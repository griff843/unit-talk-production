...
All files changed/created during the professional grading system upgrade with
grading/promotion/risk/monitoring/shadow work:
...
export const ADVICE_FEATURE_WEIGHTS = {
  ...
  recent_performance: 0.1, // Rolling 10-game performance
  ...
  // Risk Factors (20%)
  injury_risk: 0.1, // Health/injury concerns
...
export const CONFIDENCE_LEVELS = {
  ...
  MVP_BOOST: 0.1, // MVP flag confidence boost
};
```
